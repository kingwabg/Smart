        ...
        <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="publish.php">新規登録</a></li>
              <li>
                <hr class="dropdown-divider">
              </li>
              <li>
              <li><a class="dropdown-item" href="user_main.php">保有クーポン</a></li>
              <li>
                <hr class="dropdown-divider">
              </li>
    ...
    <?php foreach ($row as $r) : ?>
      <div class="row-md-4">
        <div class="card" style="width: 18rem; height: 18rem; padding: 10px;">
          ...
          <a href="show_coupon.php?id=<?= $r["id"] ?>" class="btn btn-primary w-14 h-11 
          m-1">USE</a>
        </div>
      </div>
      </div>
